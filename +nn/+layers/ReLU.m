classdef ReLU < nn.layers.template.BaseLayer
    ...
    methods
        ...
        function backward(obj, nnObj, l, opts, data, net)
            if opts.gpuMode
                nn.utils.accumulateData(opts, data, l, obj.gb(data.val{l.bottom}, data.val{l.top}, data.diff{l.top}));
            else
                nn.utils.accumulateData(opts, data, l, obj.b(data.val{l.bottom}, data.val{l.top}, data.diff{l.top}));
            end
        end
