    ...
    methods
        ...
        function forward(obj)
            ...
            if ~opts.layerSettings.enableBnorm
                ...
                data.val{obj.top} = obj.f(data.val{obj.bottom}, net.weights{obj.weights});
            end
        ...
        function backward(obj)
            ...
            if ~opts.layerSettings.enableBnorm
                ...
                [bottom_diff, weights_diff1, weights_diff2] = obj.b(data.val{obj.bottom}, data.diff{obj.top}, net.weights{obj.weights});
                data.forwardCount(obj.bottom, obj.top);
            end
        ...
        function createResources(obj, inSizes)
            obj.createResources@nn.layers.template.WeightLayer(inSizes, [1, 1, inSizes{1}(3), 1], [1, 1, inSizes{1}(3), 1]);
        end
        ...
        function outSizes = setup(obj, inSizes)
            outSizes = obj.setup@nn.layers.template.BaseLayer(opts, inSizes);
